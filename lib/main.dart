...
import 'package:flutter_app_expenses_income/firebase_options.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      locale: LanguageController().getLanguageIndex(),
      fallbackLocale: Locale('en', 'US'),
      debugShowCheckedModeBanner: false,
      title: 'Flutter Demo',
      theme: ThemeData(fontFamily: 'Battambang'),
      darkTheme: ThemeData.dark(),
      themeMode:
      DarkmodeController().isDarkMode ? ThemeMode.dark : ThemeMode.light,
...
// ThemeData themeData (){
//   return ThemeData(
//     appBarTheme: const AppBarTheme(color: kBackground),
